...
public class FuncellWebView extends WebView {
	...
	protected static void setOnWebViewCallBack(
			FuncellWebViewCallback hwWebViewCallback) {
	...
	public void loadurl(String url) {
		...
		FuncellTools.logError(TAG, "gurlString is " + urlString);
	...
	public void posturl(String url, byte[] postData) {
		urlString = FUNCELL_DOMAIN + url;
		FuncellTools.logError(TAG, "purlString is " + urlString);
	...
	private class HWWebViewClient extends WebViewClient {
		...
		public void onReceivedError(WebView view, int errorCode,
			...
			// TODO Auto-generated method stub
			view.stopLoading();
			FuncellTools.logError(TAG, errorCode + "\n" + description + "\n"
					+ failingUrl);
			view.clearView();
			showErrorPage();
