...
# Form implementation generated from reading ui file 'Dialog_mumayi.ui'
#
# Created: Fri Aug 07 15:33:44 2015
...
class Ui_Dialog_mumayi(object):
    def setupUi(self, Dialog_mumayi):
        Dialog_mumayi.setObjectName(_fromUtf8("Dialog_mumayi"))
        Dialog_mumayi.resize(645, 386)
        self.groupBox = QtGui.QGroupBox(Dialog_mumayi)
        ...
        self.gameName.setGeometry(QtCore.QRect(90, 20, 291, 20))
        ...
        self.isDebug = QtGui.QLineEdit(self.groupBox)
        self.isDebug.setGeometry(QtCore.QRect(90, 80, 291, 20))
        self.isDebug.setObjectName(_fromUtf8("isDebug"))
        self.groupBox_2 = QtGui.QGroupBox(Dialog_mumayi)
        ...
        self.pushButton = QtGui.QPushButton(Dialog_mumayi)
        self.pushButton.setGeometry(QtCore.QRect(270, 350, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.pacageName = QtGui.QLineEdit(Dialog_mumayi)
        self.pacageName.setGeometry(QtCore.QRect(60, 310, 541, 20))
        self.pacageName.setObjectName(_fromUtf8("pacageName"))
        self.label_13 = QtGui.QLabel(Dialog_mumayi)
        self.label_13.setGeometry(QtCore.QRect(20, 310, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Dialog_mumayi)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_mumayi.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_mumayi)
        self.initDialog()
    ...
    def initDialog(self):
        try:
            ...
            self.isDebug.setText(channel.get("isDebug"))
    ...
    def onOkClicked(self):
        try:
            ...
            channel.set("isDebug", unicode(self.isDebug.text()))
    ...
    def retranslateUi(self, Dialog_mumayi):
        Dialog_mumayi.setWindowTitle(_translate("Dialog_mumayi", "Dialog_mumayi", None))
        self.groupBox.setTitle(_translate("Dialog_mumayi", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_mumayi", "gameName", None))
        self.label_2.setText(_translate("Dialog_mumayi", "appKey", None))
        self.label_3.setText(_translate("Dialog_mumayi", "isDebug", None))
        self.groupBox_2.setTitle(_translate("Dialog_mumayi", "平台信息", None))
        self.label_7.setText(_translate("Dialog_mumayi", "gameId", None))
        self.label_8.setText(_translate("Dialog_mumayi", "appVersion", None))
        self.label_9.setText(_translate("Dialog_mumayi", "datacenter", None))
        self.label_10.setText(_translate("Dialog_mumayi", "platformType", None))
        self.label_11.setText(_translate("Dialog_mumayi", "resVersion", None))
        self.label_12.setText(_translate("Dialog_mumayi", "platformId", None))
        self.pushButton.setText(_translate("Dialog_mumayi", "确定", None))
        self.label_13.setText(_translate("Dialog_mumayi", "包名", None))

class Dialogmumayi(QDialog,Ui_Dialog_mumayi):  
    def __init__(self,parent=None):  
        super(Dialogmumayi,self).__init__(parent)  
        self.setupUi(self)
