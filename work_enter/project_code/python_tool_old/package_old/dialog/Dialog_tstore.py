...
# Form implementation generated from reading ui file 'Dialog_tstore.ui'
#
# Created: Thu Jan 29 16:02:52 2015
...
class Dialogtstore(QDialog,Ui_Dialog):  
    def __init__(self,parent=None):  
        super(Dialogtstore,self).__init__(parent)  
        self.setupUi(self)
