...
# Form implementation generated from reading ui file 'Dialog_xmw.ui'
#
# Created: Wed Nov 04 11:27:49 2015
...
class Ui_Dialog_xmw(object):
    def setupUi(self, Dialog_xmw):
        Dialog_xmw.setObjectName(_fromUtf8("Dialog_xmw"))
        Dialog_xmw.resize(645, 334)
        self.groupBox = QtGui.QGroupBox(Dialog_xmw)
        ...
        self.label_2.setGeometry(QtCore.QRect(13, 60, 71, 20))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.islandspace = QtGui.QLineEdit(self.groupBox)
        self.islandspace.setGeometry(QtCore.QRect(90, 50, 291, 20))
        self.islandspace.setObjectName(_fromUtf8("islandspace"))
        self.groupBox_2 = QtGui.QGroupBox(Dialog_xmw)
        ...
        self.pushButton = QtGui.QPushButton(Dialog_xmw)
        self.pushButton.setGeometry(QtCore.QRect(270, 290, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.packageName = QtGui.QLineEdit(Dialog_xmw)
        self.packageName.setGeometry(QtCore.QRect(60, 260, 541, 20))
        self.packageName.setObjectName(_fromUtf8("packageName"))
        self.label_13 = QtGui.QLabel(Dialog_xmw)
        self.label_13.setGeometry(QtCore.QRect(20, 260, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Dialog_xmw)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_xmw.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_xmw)
        self.initDialog()
    ...
    def initDialog(self):
        try:
            ...
            self.appid.setText(channel.get("xmwappid"))
            self.islandspace.setText(channel.get("islandscape"))
    ...
    def onOkClicked(self):
        try:
            ...
            channel = root.find("channel")
            channel.set("xmwappid", unicode(self.appid.text()))
            channel.set("islandscape", unicode(self.islandspace.text()))
    ...
    def retranslateUi(self, Dialog_xmw):
        Dialog_xmw.setWindowTitle(_translate("Dialog_xmw", "Dialog_xmw", None))
        self.groupBox.setTitle(_translate("Dialog_xmw", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_xmw", "appid", None))
        self.label_2.setText(_translate("Dialog_xmw", "islandspace", None))
        self.groupBox_2.setTitle(_translate("Dialog_xmw", "平台信息", None))
        self.label_7.setText(_translate("Dialog_xmw", "gameId", None))
        self.label_8.setText(_translate("Dialog_xmw", "appVersion", None))
        self.label_9.setText(_translate("Dialog_xmw", "datacenter", None))
        self.label_10.setText(_translate("Dialog_xmw", "platformType", None))
        self.label_11.setText(_translate("Dialog_xmw", "resVersion", None))
        self.label_12.setText(_translate("Dialog_xmw", "platformId", None))
        self.pushButton.setText(_translate("Dialog_xmw", "确定", None))
        self.label_13.setText(_translate("Dialog_xmw", "包名", None))

class Dialogxmw(QDialog,Ui_Dialog_xmw):  
    def __init__(self,parent=None):  
        super(Dialogxmw,self).__init__(parent)  
        self.setupUi(self)
