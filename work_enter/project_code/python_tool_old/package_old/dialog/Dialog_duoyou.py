...
# Form implementation generated from reading ui file 'Dialog_duoyou.ui'
#
...
class Ui_Dialog_duoyou(object):
    def setupUi(self, Dialog_duoyou):
        ...
        self.retranslateUi(Dialog_duoyou)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_duoyou)
        self.initDialog()

    def retranslateUi(self, Dialog_duoyou):
        Dialog_duoyou.setWindowTitle(_translate("Dialog_duoyou", "Dialog", None))
        self.pushButton.setText(_translate("Dialog_duoyou", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_duoyou", "渠道信息", None))
        self.label.setText(_translate("Dialog_duoyou", "appKey", None))
        self.label_2.setText(_translate("Dialog_duoyou", "appId", None))
        self.label_3.setText(_translate("Dialog_duoyou", "gameId", None))
        self.label_13.setText(_translate("Dialog_duoyou", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_duoyou", "平台信息", None))
        self.label_7.setText(_translate("Dialog_duoyou", "gameId", None))
        self.label_8.setText(_translate("Dialog_duoyou", "platformId", None))
        self.label_9.setText(_translate("Dialog_duoyou", "appVersion", None))
        self.label_10.setText(_translate("Dialog_duoyou", "platformType", None))
        self.label_11.setText(_translate("Dialog_duoyou", "datacenter", None))
        self.label_12.setText(_translate("Dialog_duoyou", "resVersion", None))
...
class Dialogduoyou(QDialog, Ui_Dialog_duoyou):
    def __init__(self, parent=None):  
        super(Dialogduoyou, self).__init__(parent)  
        self.setupUi(self)