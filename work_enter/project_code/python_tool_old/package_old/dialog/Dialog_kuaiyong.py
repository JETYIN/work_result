...
# Form implementation generated from reading ui file 'Dialog_kuaiyong.ui'
#
# Created: Thu Aug 20 09:22:21 2015
...
class Ui_Dialog_kuaiyong(object):
    def setupUi(self, Dialog_kuaiyong):
        Dialog_kuaiyong.setObjectName(_fromUtf8("Dialog_kuaiyong"))
        Dialog_kuaiyong.resize(645, 390)
        self.groupBox = QtGui.QGroupBox(Dialog_kuaiyong)
        ...
        self.payId.setGeometry(QtCore.QRect(90, 50, 291, 20))
        self.payId.setObjectName(_fromUtf8("payId"))
        self.label_3 = QtGui.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(20, 80, 61, 20))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.GAMESCREEN = QtGui.QLineEdit(self.groupBox)
        self.GAMESCREEN.setGeometry(QtCore.QRect(90, 80, 291, 20))
        self.GAMESCREEN.setObjectName(_fromUtf8("GAMESCREEN"))
        self.label_4 = QtGui.QLabel(self.groupBox)
        self.label_4.setGeometry(QtCore.QRect(400, 80, 141, 16))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.groupBox_2 = QtGui.QGroupBox(Dialog_kuaiyong)
        ...
        self.pushButton = QtGui.QPushButton(Dialog_kuaiyong)
        self.pushButton.setGeometry(QtCore.QRect(260, 350, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.packageName = QtGui.QLineEdit(Dialog_kuaiyong)
        self.packageName.setGeometry(QtCore.QRect(60, 310, 541, 20))
        self.packageName.setObjectName(_fromUtf8("packageName"))
        self.label_13 = QtGui.QLabel(Dialog_kuaiyong)
        self.label_13.setGeometry(QtCore.QRect(10, 310, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Dialog_kuaiyong)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_kuaiyong.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_kuaiyong)
        self.initDialog()
    ...
    def initDialog(self):
        try:
            ...
            self.GAMESCREEN.setText(channel.get("GAMESCREEN"))
    ...
    def onOkClicked(self):
        try:
            ...
            for child in metaConfigList:
                if child.attrib[key] == "GAMESCREEN":
                    child.set(value, unicode(self.GAMESCREEN.text()))
                elif child.attrib[key] == "HI_GAMEID":
                    child.set(value, unicode(self.payId.text()))
                elif child.attrib[key] == "HI_GAMEKEY":
            ...
            channel.set("GAMESCREEN", unicode(self.GAMESCREEN.text()))
    ...
    def retranslateUi(self, Dialog_kuaiyong):
        Dialog_kuaiyong.setWindowTitle(_translate("Dialog_kuaiyong", "Dialog_kuaiyong", None))
        self.groupBox.setTitle(_translate("Dialog_kuaiyong", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_kuaiyong", "appkey", None))
        self.label_2.setText(_translate("Dialog_kuaiyong", "payId", None))
        self.label_3.setText(_translate("Dialog_kuaiyong", "GAMESCREEN", None))
        self.label_4.setText(_translate("Dialog_kuaiyong", "(0:竖屏 1：横屏)", None))
        self.groupBox_2.setTitle(_translate("Dialog_kuaiyong", "平台信息", None))
        self.label_7.setText(_translate("Dialog_kuaiyong", "gameId", None))
        self.label_8.setText(_translate("Dialog_kuaiyong", "appVersion", None))
        self.label_9.setText(_translate("Dialog_kuaiyong", "datacenter", None))
        self.label_10.setText(_translate("Dialog_kuaiyong", "platformType", None))
        self.label_11.setText(_translate("Dialog_kuaiyong", "resVersion", None))
        self.label_12.setText(_translate("Dialog_kuaiyong", "platformId", None))
        self.pushButton.setText(_translate("Dialog_kuaiyong", "确定", None))
        self.label_13.setText(_translate("Dialog_kuaiyong", "包名", None))

class Dialogkuaiyong(QDialog,Ui_Dialog_kuaiyong):  
    def __init__(self,parent=None):  
        super(Dialogkuaiyong,self).__init__(parent)  
        self.setupUi(self)
