...
# Form implementation generated from reading ui file 'Dialog_4399.ui'
#
# Created: Fri Jul 31 11:38:06 2015
...
class Ui_Dialog_4399(object):
    def setupUi(self, Dialog_4399):
        Dialog_4399.setObjectName(_fromUtf8("Dialog_4399"))
        Dialog_4399.resize(441, 284)
        self.pushButton = QtGui.QPushButton(Dialog_4399)
        self.pushButton.setGeometry(QtCore.QRect(170, 250, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_4399)
        ...
        self.groupBox_4 = QtGui.QGroupBox(Dialog_4399)
    ...
    def retranslateUi(self, Dialog_4399):
        Dialog_4399.setWindowTitle(_translate("Dialog_4399", "Dialog_4399", None))
        self.pushButton.setText(_translate("Dialog_4399", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_4399", "渠道信息", None))
        self.label.setText(_translate("Dialog_4399", "appkey", None))
        self.groupBox_4.setTitle(_translate("Dialog_4399", "平台信息", None))
        self.label_7.setText(_translate("Dialog_4399", "gameId", None))
        self.label_8.setText(_translate("Dialog_4399", "platformId", None))
        self.label_9.setText(_translate("Dialog_4399", "appVersion", None))
        self.label_10.setText(_translate("Dialog_4399", "platformType", None))
        self.label_11.setText(_translate("Dialog_4399", "datacenter", None))
        self.label_12.setText(_translate("Dialog_4399", "resVersion", None))
        self.label_13.setText(_translate("Dialog_4399", "包名", None))

class Dialog4399(QDialog,Ui_Dialog_4399):  
    def __init__(self,parent=None):  
        super(Dialog4399,self).__init__(parent)  
        self.setupUi(self)
