...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.WWS_CHANNEL_2 = QtGui.QLabel(self.groupBox)
        self.WWS_CHANNEL_2.setGeometry(QtCore.QRect(10, 110, 71, 20))
        self.WWS_CHANNEL_2.setObjectName(_fromUtf8("WWS_CHANNEL_2"))
        self.lineEdit_4 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_4.setGeometry(QtCore.QRect(90, 110, 261, 20))
        self.lineEdit_4.setObjectName(_fromUtf8("lineEdit_4"))
        self.WWS_CHANNEL_4 = QtGui.QLabel(self.groupBox)
        self.WWS_CHANNEL_4.setGeometry(QtCore.QRect(20, 130, 331, 20))
        self.WWS_CHANNEL_4.setObjectName(_fromUtf8("WWS_CHANNEL_4"))
        ...
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 310, 361, 20))
    ...
    def initDialog(self):
        try:
            ...
            for child in metaConfigList:
                ...
                elif child.attrib[key] == "WWS_CHANNEL_NAME":
    ...
    def retranslateUi(self, Dialog):
        ...
        self.WWS_CHANNEL_2.setText(_translate("Dialog", "CHANNEL_NAME", None))
        self.WWS_CHANNEL_4.setText(_translate("Dialog", "说明：CHANNEL_NAME为 乐变渠道需要的标识，渠道名", None))
...
class Dialogfuncell_reyun_appsflyer(QDialog,Ui_Dialog):
    def __init__(self,parent=None):  
        super(Dialogfuncell_reyun_appsflyer,self).__init__(parent)  
        self.setupUi(self)
