...
# Form implementation generated from reading ui file 'Dialog_pengyouwan.ui'
#
...
class Ui_Dialog_pengyouwan(object):
    def setupUi(self, Dialog_pengyouwan):
        Dialog_pengyouwan.setObjectName(_fromUtf8("Dialog_pengyouwan"))
        Dialog_pengyouwan.resize(447, 419)
        self.pushButton = QtGui.QPushButton(Dialog_pengyouwan)
        self.pushButton.setGeometry(QtCore.QRect(180, 380, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_pengyouwan)
        self.groupBox.setGeometry(QtCore.QRect(10, 20, 381, 171))
        ...
        self.label_13 = QtGui.QLabel(Dialog_pengyouwan)
        self.label_13.setGeometry(QtCore.QRect(10, 340, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.lineEdit_11 = QtGui.QLineEdit(Dialog_pengyouwan)
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 336, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog_pengyouwan)
        ...
        self.retranslateUi(Dialog_pengyouwan)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_pengyouwan)
        self.initDialog()

    def retranslateUi(self, Dialog_pengyouwan):
        Dialog_pengyouwan.setWindowTitle(_translate("Dialog_pengyouwan", "Dialog_kaiyou", None))
        self.pushButton.setText(_translate("Dialog_pengyouwan", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_pengyouwan", "渠道信息", None))
        self.label.setText(_translate("Dialog_pengyouwan", "gameKey", None))
        self.label_13.setText(_translate("Dialog_pengyouwan", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_pengyouwan", "平台信息", None))
        self.label_7.setText(_translate("Dialog_pengyouwan", "gameId", None))
        self.label_8.setText(_translate("Dialog_pengyouwan", "platformId", None))
        self.label_9.setText(_translate("Dialog_pengyouwan", "appVersion", None))
        self.label_10.setText(_translate("Dialog_pengyouwan", "platformType", None))
        self.label_11.setText(_translate("Dialog_pengyouwan", "datacenter", None))
        self.label_12.setText(_translate("Dialog_pengyouwan", "resVersion", None))
    ...
    def initDialog(self):
        try:
            ...
            self.lineEdit.setText(channel.get("gameKey"))
    ...
    def onOkClicked(self):
        try:
            ...
            #渠道信息
            channel = root.find("channel")
            channel.set("gameKey", unicode(self.lineEdit.text()))
...
class Dialogpengyouwan(QDialog,Ui_Dialog_pengyouwan):
    def __init__(self,parent=None):  
        super(Dialogpengyouwan,self).__init__(parent)  
        self.setupUi(self)
