...
# Form implementation generated from reading ui file 'Dialog_yijie.ui'
#
# Created: Thu Oct 15 15:13:41 2015
...
class Ui_Dialog_yijie(object):
    def setupUi(self, Dialog_yijie):
        Dialog_yijie.setObjectName(_fromUtf8("Dialog_yijie"))
        Dialog_yijie.resize(645, 334)
        self.groupBox = QtGui.QGroupBox(Dialog_yijie)
        ...
        self.pushButton = QtGui.QPushButton(Dialog_yijie)
        self.pushButton.setGeometry(QtCore.QRect(270, 290, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.packageName = QtGui.QLineEdit(Dialog_yijie)
        self.packageName.setGeometry(QtCore.QRect(60, 260, 541, 20))
        self.packageName.setObjectName(_fromUtf8("packageName"))
        self.label_13 = QtGui.QLabel(Dialog_yijie)
        self.label_13.setGeometry(QtCore.QRect(20, 260, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Dialog_yijie)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_yijie.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_yijie)
        self.initDialog()
    ...
    def retranslateUi(self, Dialog_yijie):
        Dialog_yijie.setWindowTitle(_translate("Dialog_yijie", "Dialog_yijie", None))
        self.groupBox.setTitle(_translate("Dialog_yijie", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_yijie", "currency", None))
        self.label_2.setText(_translate("Dialog_yijie", "元宝，钻石", None))
        self.label_3.setText(_translate("Dialog_yijie", "appid", None))
        self.groupBox_2.setTitle(_translate("Dialog_yijie", "平台信息", None))
        self.label_7.setText(_translate("Dialog_yijie", "gameId", None))
        self.label_8.setText(_translate("Dialog_yijie", "appVersion", None))
        self.label_9.setText(_translate("Dialog_yijie", "datacenter", None))
        self.label_10.setText(_translate("Dialog_yijie", "platformType", None))
        self.label_11.setText(_translate("Dialog_yijie", "resVersion", None))
        self.label_12.setText(_translate("Dialog_yijie", "platformId", None))
        self.pushButton.setText(_translate("Dialog_yijie", "确定", None))
        self.label_13.setText(_translate("Dialog_yijie", "包名", None))

class Dialogyijie(QDialog,Ui_Dialog_yijie):  
    def __init__(self,parent=None):  
        super(Dialogyijie,self).__init__(parent)  
        self.setupUi(self)
