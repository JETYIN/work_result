...
# Form implementation generated from reading ui file 'Dialog_hmwan.ui'
#
# Created: Wed Aug 05 19:24:19 2015
...
class Ui_Dialog_hmwan(object):
    def setupUi(self, Dialog_hmwan):
        Dialog_hmwan.setObjectName(_fromUtf8("Dialog_hmwan"))
        Dialog_hmwan.resize(645, 325)
        self.groupBox = QtGui.QGroupBox(Dialog_hmwan)
        ...
        self.gameName.setGeometry(QtCore.QRect(90, 50, 291, 20))
        self.gameName.setObjectName(_fromUtf8("gameName"))
        self.groupBox_2 = QtGui.QGroupBox(Dialog_hmwan)
        ...
        self.pushButton = QtGui.QPushButton(Dialog_hmwan)
        self.pushButton.setGeometry(QtCore.QRect(270, 290, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.packageName = QtGui.QLineEdit(Dialog_hmwan)
        self.packageName.setGeometry(QtCore.QRect(60, 260, 541, 20))
        self.packageName.setObjectName(_fromUtf8("packageName"))
        self.label_13 = QtGui.QLabel(Dialog_hmwan)
        self.label_13.setGeometry(QtCore.QRect(20, 260, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Dialog_hmwan)
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_hmwan.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_hmwan)
        self.initDialog()
    ...
    def retranslateUi(self, Dialog_hmwan):
        Dialog_hmwan.setWindowTitle(_translate("Dialog_hmwan", "Dialog_hmwan", None))
        self.groupBox.setTitle(_translate("Dialog_hmwan", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_hmwan", "appId", None))
        self.label_2.setText(_translate("Dialog_hmwan", "gameName", None))
        self.groupBox_2.setTitle(_translate("Dialog_hmwan", "平台信息", None))
        self.label_7.setText(_translate("Dialog_hmwan", "gameId", None))
        self.label_8.setText(_translate("Dialog_hmwan", "appVersion", None))
        self.label_9.setText(_translate("Dialog_hmwan", "datacenter", None))
        self.label_10.setText(_translate("Dialog_hmwan", "platformType", None))
        self.label_11.setText(_translate("Dialog_hmwan", "resVersion", None))
        self.label_12.setText(_translate("Dialog_hmwan", "platformId", None))
        self.pushButton.setText(_translate("Dialog_hmwan", "确定", None))
        self.label_13.setText(_translate("Dialog_hmwan", "包名", None))

class Dialoghmwan(QDialog,Ui_Dialog_hmwan):  
    def __init__(self,parent=None):  
        super(Dialoghmwan,self).__init__(parent)  
        self.setupUi(self)