...
# Form implementation generated from reading ui file 'Dialog_qiqile.ui'
#
...
class Ui_Dialog_qiqile(object):
    def setupUi(self, Dialog_qiqile):
        Dialog_qiqile.setObjectName(_fromUtf8("Dialog_qiqile"))
        Dialog_qiqile.resize(447, 419)
        self.pushButton = QtGui.QPushButton(Dialog_qiqile)
        self.pushButton.setGeometry(QtCore.QRect(180, 380, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_qiqile)
        ...
        self.retranslateUi(Dialog_qiqile)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_qiqile)
        self.initDialog()


    def retranslateUi(self, Dialog_qiqile):
        Dialog_qiqile.setWindowTitle(_translate("Dialog_qiqile", "Dialog", None))
        self.pushButton.setText(_translate("Dialog_qiqile", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_qiqile", "渠道信息", None))
        self.label.setText(_translate("Dialog_qiqile", "appKey", None))
        self.label_2.setText(_translate("Dialog_qiqile", "appId", None))
        self.label_13.setText(_translate("Dialog_qiqile", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_qiqile", "平台信息", None))
        self.label_7.setText(_translate("Dialog_qiqile", "gameId", None))
        self.label_8.setText(_translate("Dialog_qiqile", "platformId", None))
        self.label_9.setText(_translate("Dialog_qiqile", "appVersion", None))
        self.label_10.setText(_translate("Dialog_qiqile", "platformType", None))
        self.label_11.setText(_translate("Dialog_qiqile", "datacenter", None))
        self.label_12.setText(_translate("Dialog_qiqile", "resVersion", None))
...
class Dialogqiqile(QDialog, Ui_Dialog_qiqile):
    def __init__(self, parent=None):  
        super(Dialogqiqile, self).__init__(parent)  
        self.setupUi(self)