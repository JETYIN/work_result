...
# Form implementation generated from reading ui file 'Dialog_weien.ui'
#
...
class Ui_Dialog_weien(object):
    def setupUi(self, Dialog_weien):
        Dialog_weien.setObjectName(_fromUtf8("Dialog_weien"))
        Dialog_weien.resize(640, 397)
        self.groupBox = QtGui.QGroupBox(Dialog_weien)
        ...
        self.groupBox_2 = QtGui.QGroupBox(Dialog_weien)
    ...
    def retranslateUi(self, Dialog_weien):
        Dialog_weien.setWindowTitle(_translate("Dialog_weien", "Dialog", None))
        self.groupBox.setTitle(_translate("Dialog_weien", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_weien", "appId", None))
        self.label_2.setText(_translate("Dialog_weien", "appKey", None))
        self.groupBox_2.setTitle(_translate("Dialog_weien", "平台信息", None))
        self.label_7.setText(_translate("Dialog_weien", "gameId", None))
        self.label_8.setText(_translate("Dialog_weien", "appVersion", None))
        self.label_9.setText(_translate("Dialog_weien", "datacenter", None))
        self.label_10.setText(_translate("Dialog_weien", "platformType", None))
        self.label_11.setText(_translate("Dialog_weien", "resVersion", None))
        self.label_12.setText(_translate("Dialog_weien", "platformId", None))
        self.pushButton.setText(_translate("Dialog_weien", "确定", None))
        self.label_13.setText(_translate("Dialog_weien", "包名", None))

class Dialogweien(QDialog,Ui_Dialog_weien):
    def __init__(self,parent=None):  
        super(Dialogweien,self).__init__(parent)  
        self.setupUi(self)