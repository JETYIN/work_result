...
class Ui_Dialog_funcell_google(object):
    ...
    def retranslateUi(self, Dialog_funcell_google):
        Dialog_funcell_google.setWindowTitle(_translate("Dialog_funcell_google", "Dialog_funcell_google", None))
...
class Dialograink_kr_bf_google(QDialog,Ui_Dialog_funcell_google):  
    def __init__(self,parent=None):  
        super(Dialograink_kr_bf_google,self).__init__(parent)  
        self.setupUi(self)
