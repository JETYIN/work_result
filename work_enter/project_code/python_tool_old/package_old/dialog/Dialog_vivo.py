...
# Form implementation generated from reading ui file 'Dialog_vivo.ui'
#
# Created: Tue Jan 27 17:03:18 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(442, 368)
        self.pushButton = QtGui.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(186, 330, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 351, 121))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.lineEdit_3 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_3.setGeometry(QtCore.QRect(71, 82, 261, 20))
        self.lineEdit_3.setObjectName(_fromUtf8("lineEdit_3"))
        self.label_2 = QtGui.QLabel(self.groupBox)
        self.label_2.setGeometry(QtCore.QRect(11, 52, 54, 12))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtGui.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(11, 82, 54, 12))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label = QtGui.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(11, 22, 54, 12))
        self.label.setObjectName(_fromUtf8("label"))
        self.lineEdit = QtGui.QLineEdit(self.groupBox)
        self.lineEdit.setGeometry(QtCore.QRect(71, 22, 261, 20))
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.lineEdit_2 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_2.setGeometry(QtCore.QRect(71, 52, 261, 20))
        self.lineEdit_2.setObjectName(_fromUtf8("lineEdit_2"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 140, 421, 121))
        ...
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 286, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.label_13 = QtGui.QLabel(Dialog)
        self.label_13.setGeometry(QtCore.QRect(10, 290, 54, 12))
    ...
    def initDialog(self):
        ...
        self.lineEdit_2.setText(channel.get("storeID"))
        self.lineEdit_3.setText(channel.get("storeKey"))
    ...
    def onOkClicked(self):
        try:
            ...
            channel.set("storeID", unicode(self.lineEdit_2.text())) 
            channel.set("storeKey", unicode(self.lineEdit_3.text())) 
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Dialog_vivo", None))
        self.pushButton.setText(_translate("Dialog", "确定", None))
        self.groupBox.setTitle(_translate("Dialog", "渠道信息", None))
        self.label_2.setText(_translate("Dialog", "storeID", None))
        self.label_3.setText(_translate("Dialog", "storeKey", None))
...
class Dialogvivo(QDialog,Ui_Dialog):  
    def __init__(self,parent=None):  
        super(Dialogvivo,self).__init__(parent)  
        self.setupUi(self)
