...
class Ui_Dialog_kaopu_rehe(object):
    def setupUi(self, Dialog_kaopu_rehe):
        Dialog_kaopu_rehe.setObjectName(_fromUtf8("Dialog_kaopu_rehe"))
        Dialog_kaopu_rehe.resize(447, 419)
        self.pushButton = QtGui.QPushButton(Dialog_kaopu_rehe)
        self.pushButton.setGeometry(QtCore.QRect(180, 380, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_kaopu_rehe)
        ...
        self.label_13 = QtGui.QLabel(Dialog_kaopu_rehe)
        self.label_13.setGeometry(QtCore.QRect(10, 340, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.lineEdit_11 = QtGui.QLineEdit(Dialog_kaopu_rehe)
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 336, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog_kaopu_rehe)
        ...
        self.retranslateUi(Dialog_kaopu_rehe)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_kaopu_rehe)
        self.initDialog()
...
class Dialogkaopu_rehe(QDialog,Ui_Dialog_kaopu_rehe):
    def __init__(self,parent=None):  
        super(Dialogkaopu_rehe,self).__init__(parent)  
        self.setupUi(self)