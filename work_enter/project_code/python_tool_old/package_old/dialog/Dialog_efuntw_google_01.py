...
class Ui_Dialog_efuntw_google_01(object):
    def setupUi(self, Dialog_efuntw_google_01):
        Dialog_efuntw_google_01.setObjectName(_fromUtf8("Dialog_efuntw_google_01"))
        Dialog_efuntw_google_01.resize(625, 469)
        self.packageName = QtGui.QLineEdit(Dialog_efuntw_google_01)
        self.packageName.setGeometry(QtCore.QRect(60, 230, 541, 20))
        self.packageName.setObjectName(_fromUtf8("packageName"))
        self.pushButton = QtGui.QPushButton(Dialog_efuntw_google_01)
        self.pushButton.setGeometry(QtCore.QRect(260, 270, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_efuntw_google_01)
        self.groupBox.setGeometry(QtCore.QRect(20, 10, 581, 80))
        ...
        self.groupBox_2 = QtGui.QGroupBox(Dialog_efuntw_google_01)
        ...
        self.label_13 = QtGui.QLabel(Dialog_efuntw_google_01)
        self.label_13.setGeometry(QtCore.QRect(20, 230, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Dialog_efuntw_google_01)
        QtCore.QMetaObject.connectSlotsByName(Dialog_efuntw_google_01)
        
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_efuntw_google_01.onOkClicked)
        self.initDialog()
...
#             return -1
    ...
    def retranslateUi(self, Dialog_efuntw_google):
        ...
        self.label_15.setText(_translate("Dialog_efuntw_google", "渠道类型：google|asus", None))
        self.label_2.setText(_translate("Dialog_efuntw_google", "channelType", None))
...
class Dialogefuntw_google_01(QDialog,Ui_Dialog_efuntw_google_01):  
    def __init__(self,parent=None):  
        super(Dialogefuntw_google_01,self).__init__(parent)  
        self.setupUi(self)
