...
# Form implementation generated from reading ui file 'F:\funcellsdk\ReleaseSDK\android_pack_talkingdata\ui\Dialog_tw_joycell_google.ui'
#
# Created: Sat May 16 14:13:33 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_13.setGeometry(QtCore.QRect(10, 394, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.lineEdit_11 = QtGui.QLineEdit(Dialog)
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 390, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.label = QtGui.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(20, 140, 71, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.lineEdit_4 = QtGui.QLineEdit(Dialog)
        self.lineEdit_4.setGeometry(QtCore.QRect(100, 140, 261, 20))
        self.lineEdit_4.setObjectName(_fromUtf8("lineEdit_4"))
        self.label_2 = QtGui.QLabel(Dialog)
        self.label_2.setGeometry(QtCore.QRect(370, 140, 54, 12))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtGui.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(20, 170, 61, 16))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.lineEdit_5 = QtGui.QLineEdit(Dialog)
        self.lineEdit_5.setGeometry(QtCore.QRect(100, 170, 261, 20))
        self.lineEdit_5.setObjectName(_fromUtf8("lineEdit_5"))
        self.label_4 = QtGui.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(370, 170, 71, 16))
    ...
    def initDialog(self):
        try:
            ...
            self.lineEdit_4.setText(channel.get("privateKey"))
            self.lineEdit_5.setText(channel.get("funcellKey"))
            self.lineEdit_4.setText(channel.get("privateKey"))
            self.lineEdit_5.setText(channel.get("funcellKey"))
    ...
    def onOkClicked(self):
        try:
            ...
            channel.set("privateKey", unicode(self.lineEdit_4.text())) 
            channel.set("funcellKey", unicode(self.lineEdit_5.text())) 
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Dialog_tw_joycell_google", None))
        ...
        self.label_2.setText(_translate("Dialog", "googleKey", None))
        self.label_3.setText(_translate("Dialog", "funcellKey", None))
        self.label_4.setText(_translate("Dialog", "平台验证Key", None))
        
class Dialogtw_joycell_google(QDialog,Ui_Dialog):
    def __init__(self,parent=None):  
        super(Dialogtw_joycell_google,self).__init__(parent)  
        self.setupUi(self)
