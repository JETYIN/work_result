...
# Form implementation generated from reading ui file 'Dialog_yijiechouqing.ui'
#
...
class Ui_Dialog_yijiechouqing(object):
    def setupUi(self, Dialog_yijiechouqing):
        Dialog_yijiechouqing.setObjectName(_fromUtf8("Dialog_yijiechouqing"))
        Dialog_yijiechouqing.resize(447, 419)
        self.pushButton = QtGui.QPushButton(Dialog_yijiechouqing)
        self.pushButton.setGeometry(QtCore.QRect(180, 380, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_yijiechouqing)
        ...
        self.retranslateUi(Dialog_yijiechouqing)
        QtCore.QMetaObject.connectSlotsByName(Dialog_yijiechouqing)
        self.pushButton.clicked.connect(self.onOkClicked)
        self.initDialog()

    def retranslateUi(self, Dialog_yijiechouqing):
        Dialog_yijiechouqing.setWindowTitle(_translate("Dialog_yijiechouqing", "Dialog", None))
        self.pushButton.setText(_translate("Dialog_yijiechouqing", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_yijiechouqing", "渠道信息", None))
        self.label_2.setText(_translate("Dialog_yijiechouqing", "appId", None))
        self.label_13.setText(_translate("Dialog_yijiechouqing", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_yijiechouqing", "平台信息", None))
        self.label_7.setText(_translate("Dialog_yijiechouqing", "gameId", None))
        self.label_8.setText(_translate("Dialog_yijiechouqing", "platformId", None))
        self.label_9.setText(_translate("Dialog_yijiechouqing", "appVersion", None))
        self.label_10.setText(_translate("Dialog_yijiechouqing", "platformType", None))
        self.label_11.setText(_translate("Dialog_yijiechouqing", "datacenter", None))
        self.label_12.setText(_translate("Dialog_yijiechouqing", "resVersion", None))
...
class Dialogyijiechouqing(QDialog, Ui_Dialog_yijiechouqing):
    def __init__(self, parent=None):  
        super(Dialogyijiechouqing, self).__init__(parent)  
        self.setupUi(self)