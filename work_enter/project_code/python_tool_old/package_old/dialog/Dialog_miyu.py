...
# Form implementation generated from reading ui file 'Dialog_miyu.ui'
#
...
class Ui_Dialog_miyu(object):
    def setupUi(self, Dialog_miyu):
        Dialog_miyu.setObjectName(_fromUtf8("Dialog_miyu"))
        Dialog_miyu.resize(640, 397)
        self.groupBox = QtGui.QGroupBox(Dialog_miyu)
        ...
        self.gameName.setGeometry(QtCore.QRect(90, 20, 181, 20))
        self.gameName.setObjectName(_fromUtf8("gameName"))
        self.label_2 = QtGui.QLabel(self.groupBox)
        self.label_2.setGeometry(QtCore.QRect(20, 60, 54, 12))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.payUnit = QtGui.QLineEdit(self.groupBox)
        self.payUnit.setGeometry(QtCore.QRect(90, 50, 181, 20))
        self.payUnit.setObjectName(_fromUtf8("payUnit"))
        self.label = QtGui.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(340, 50, 81, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.groupBox_2 = QtGui.QGroupBox(Dialog_miyu)
    ...
    def initDialog(self):
        try:
            ...
            self.payUnit.setText(channel.get("payUnit"))
    ...
    def onOkClicked(self):
        try:
            ...
            channel.set("payUnit", unicode(self.payUnit.text()))
    ...
    def retranslateUi(self, Dialog_miyu):
        Dialog_miyu.setWindowTitle(_translate("Dialog_miyu", "Dialog", None))
        self.groupBox.setTitle(_translate("Dialog_miyu", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_miyu", "游戏名称", None))
        self.label_2.setText(_translate("Dialog_miyu", "支付类别", None))
        self.label.setText(_translate("Dialog_miyu", "(元宝、钻石)", None))
        self.groupBox_2.setTitle(_translate("Dialog_miyu", "平台信息", None))
        self.label_7.setText(_translate("Dialog_miyu", "gameId", None))
        self.label_8.setText(_translate("Dialog_miyu", "appVersion", None))
        self.label_9.setText(_translate("Dialog_miyu", "datacenter", None))
        self.label_10.setText(_translate("Dialog_miyu", "platformType", None))
        self.label_11.setText(_translate("Dialog_miyu", "resVersion", None))
        self.label_12.setText(_translate("Dialog_miyu", "platformId", None))
        self.pushButton.setText(_translate("Dialog_miyu", "确定", None))
        self.label_13.setText(_translate("Dialog_miyu", "包名", None))

class Dialogmiyu(QDialog,Ui_Dialog_miyu):
    def __init__(self,parent=None):  
        super(Dialogmiyu,self).__init__(parent)  
        self.setupUi(self)