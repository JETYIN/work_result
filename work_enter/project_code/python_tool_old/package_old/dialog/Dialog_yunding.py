...
class Ui_Dialog_yunding(object):
    def setupUi(self, Dialog_yunding):
        Dialog_yunding.setObjectName(_fromUtf8("Dialog_yunding"))
        Dialog_yunding.resize(645, 766)
        self.groupBox = QtGui.QGroupBox(Dialog_yunding)
        ...
        self.groupBox_2 = QtGui.QGroupBox(Dialog_yunding)
...
class Dialogyunding(QDialog,Ui_Dialog_yunding):  
    def __init__(self,parent=None):  
        super(Dialogyunding,self).__init__(parent)  
        self.setupUi(self)
