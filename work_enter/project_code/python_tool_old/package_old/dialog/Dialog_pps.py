...
# Form implementation generated from reading ui file 'Dialog_pps.ui'
#
# Created: Tue Sep 08 11:04:09 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ppsGameId = QtGui.QLineEdit(self.groupBox)
        self.ppsGameId.setGeometry(QtCore.QRect(130, 20, 291, 20))
        self.ppsGameId.setObjectName(_fromUtf8("ppsGameId"))
    ...
    def initDialog(self):
        try:
            ...
            self.ppsGameId.setText(channel.get("ppsGameId"))
    ...
    def onOkClicked(self):
        try:
            ...
            channel = root.find("channel")
            channel.set("ppsGameId", unicode(self.ppsGameId.text()))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_23.setText(_translate("Dialog", "ppsGameId", None))


class Dialogpps(QDialog,Ui_Dialog):  
    def __init__(self,parent=None):  
        super(Dialogpps,self).__init__(parent)  
        self.setupUi(self)
