...
# Form implementation generated from reading ui file 'Dialog_360.ui'
#
# Created: Sat Jan 24 11:37:20 2015
...
class Ui_Dialog_360(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox_2.setItemText(0, _translate("Dialog", "true", None))
        self.comboBox_2.setItemText(1, _translate("Dialog", "false", None))
        self.label_2.setText(_translate("Dialog", "isLandscape", None))
        self.label_3.setText(_translate("Dialog", "isTransparent", None))
        self.label_4.setText(_translate("Dialog", "exchangeRate", None))
        self.label_6.setText(_translate("Dialog", "appKey", None))
        self.label.setText(_translate("Dialog", "gameName", None))
        self.label_8.setText(_translate("Dialog", "weixinAppId", None))
        self.label_5.setText(_translate("Dialog", "appId", None))
        self.comboBox.setItemText(0, _translate("Dialog", "true", None))
        self.comboBox.setItemText(1, _translate("Dialog", "false", None))
        self.label_7.setText(_translate("Dialog", "appSecret", None))
...
class Dialog360(QDialog,Ui_Dialog_360):  
    def __init__(self,parent=None):  
        super(Dialog360,self).__init__(parent)  
        self.setupUi(self)
