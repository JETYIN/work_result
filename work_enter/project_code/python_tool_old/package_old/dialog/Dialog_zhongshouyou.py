...
# Form implementation generated from reading ui file 'Dialog_zhongshouyou.ui'
#
...
class Ui_Dialog_zhongshouyou(object):
    def setupUi(self, Dialog_zhongshouyou):
        Dialog_zhongshouyou.setObjectName(_fromUtf8("Dialog_zhongshouyou"))
        Dialog_zhongshouyou.resize(447, 419)
        self.pushButton = QtGui.QPushButton(Dialog_zhongshouyou)
        self.pushButton.setGeometry(QtCore.QRect(180, 380, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_zhongshouyou)
        ...
        self.label_13 = QtGui.QLabel(Dialog_zhongshouyou)
        self.label_13.setGeometry(QtCore.QRect(10, 340, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.lineEdit_11 = QtGui.QLineEdit(Dialog_zhongshouyou)
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 336, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog_zhongshouyou)
        ...
        self.retranslateUi(Dialog_zhongshouyou)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_zhongshouyou)
        self.initDialog()

    def retranslateUi(self, Dialog_zhongshouyou):
        Dialog_zhongshouyou.setWindowTitle(_translate("Dialog_zhongshouyou", "Dialog_zhongshouyou", None))
        self.pushButton.setText(_translate("Dialog_zhongshouyou", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_zhongshouyou", "渠道信息", None))
        self.label.setText(_translate("Dialog_zhongshouyou", "appkey", None))
        self.label_13.setText(_translate("Dialog_zhongshouyou", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_zhongshouyou", "平台信息", None))
        self.label_7.setText(_translate("Dialog_zhongshouyou", "gameId", None))
        self.label_8.setText(_translate("Dialog_zhongshouyou", "platformId", None))
        self.label_9.setText(_translate("Dialog_zhongshouyou", "appVersion", None))
        self.label_10.setText(_translate("Dialog_zhongshouyou", "platformType", None))
        self.label_11.setText(_translate("Dialog_zhongshouyou", "datacenter", None))
        self.label_12.setText(_translate("Dialog_zhongshouyou", "resVersion", None))
...
class Dialogcmge(QDialog,Ui_Dialog_zhongshouyou):
    def __init__(self,parent=None):  
        super(Dialogcmge,self).__init__(parent)  
        self.setupUi(self)