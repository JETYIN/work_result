...
# Form implementation generated from reading ui file 'F:\android_pack_talkingdata\ui\Dialog_efuntw_asus.ui'
#
...
class Ui_Dialog_efuntw_asus(object):
    def setupUi(self, Dialog_efuntw_asus):
        Dialog_efuntw_asus.setObjectName(_fromUtf8("Dialog_efuntw_asus"))
        Dialog_efuntw_asus.resize(624, 324)
        self.pushButton = QtGui.QPushButton(Dialog_efuntw_asus)
        self.pushButton.setGeometry(QtCore.QRect(260, 270, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.packageName = QtGui.QLineEdit(Dialog_efuntw_asus)
        self.packageName.setGeometry(QtCore.QRect(60, 230, 541, 20))
        self.packageName.setObjectName(_fromUtf8("packageName"))
        self.groupBox = QtGui.QGroupBox(Dialog_efuntw_asus)
        ...
        self.groupBox_2 = QtGui.QGroupBox(Dialog_efuntw_asus)
        ...
        self.label_13 = QtGui.QLabel(Dialog_efuntw_asus)
        self.label_13.setGeometry(QtCore.QRect(20, 230, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Dialog_efuntw_asus)
        QtCore.QMetaObject.connectSlotsByName(Dialog_efuntw_asus)
        
        
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_efuntw_asus.onOkClicked)
        self.initDialog()
...
#             return -1
    ...
    def retranslateUi(self, Dialog_efuntw_asus):
        Dialog_efuntw_asus.setWindowTitle(_translate("Dialog_efuntw_asus", "Dialog", None))
        self.pushButton.setText(_translate("Dialog_efuntw_asus", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_efuntw_asus", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_efuntw_asus", "gameName", None))
        self.groupBox_2.setTitle(_translate("Dialog_efuntw_asus", "平台信息", None))
        self.label_7.setText(_translate("Dialog_efuntw_asus", "gameId", None))
        self.label_8.setText(_translate("Dialog_efuntw_asus", "appVersion", None))
        self.label_9.setText(_translate("Dialog_efuntw_asus", "datacenter", None))
        self.label_10.setText(_translate("Dialog_efuntw_asus", "platformType", None))
        self.label_11.setText(_translate("Dialog_efuntw_asus", "resVersion", None))
        self.label_12.setText(_translate("Dialog_efuntw_asus", "platformId", None))
        self.label_13.setText(_translate("Dialog_efuntw_asus", "包名", None))

class Dialogefuntw_asus(QDialog,Ui_Dialog_efuntw_asus):  
    def __init__(self,parent=None):  
        super(Dialogefuntw_asus,self).__init__(parent)  
        self.setupUi(self)