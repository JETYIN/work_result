...
# Form implementation generated from reading ui file 'Dialog_37wan.ui'
#
...
class Ui_Dialog_37wan(object):
    def setupUi(self, Dialog_37wan):
        Dialog_37wan.setObjectName(_fromUtf8("Dialog_37wan"))
        Dialog_37wan.resize(447, 419)
        self.pushButton = QtGui.QPushButton(Dialog_37wan)
        self.pushButton.setGeometry(QtCore.QRect(180, 380, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_37wan)
        ...
        self.label_13 = QtGui.QLabel(Dialog_37wan)
        self.label_13.setGeometry(QtCore.QRect(10, 340, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.lineEdit_11 = QtGui.QLineEdit(Dialog_37wan)
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 336, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog_37wan)
        ...
        self.retranslateUi(Dialog_37wan)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_37wan)
        self.initDialog()
        
    def retranslateUi(self, Dialog_37wan):
        Dialog_37wan.setWindowTitle(_translate("Dialog_37wan", "Dialog_37wan", None))
        self.pushButton.setText(_translate("Dialog_37wan", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_37wan", "渠道信息", None))
        self.label.setText(_translate("Dialog_37wan", "appkey", None))
        self.label_13.setText(_translate("Dialog_37wan", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_37wan", "平台信息", None))
        self.label_7.setText(_translate("Dialog_37wan", "gameId", None))
        self.label_8.setText(_translate("Dialog_37wan", "platformId", None))
        self.label_9.setText(_translate("Dialog_37wan", "appVersion", None))
        self.label_10.setText(_translate("Dialog_37wan", "platformType", None))
        self.label_11.setText(_translate("Dialog_37wan", "datacenter", None))
        self.label_12.setText(_translate("Dialog_37wan", "resVersion", None))
...
class Dialog37wan(QDialog,Ui_Dialog_37wan):
    def __init__(self,parent=None):  
        super(Dialog37wan,self).__init__(parent)  
        self.setupUi(self)
