...
# Form implementation generated from reading ui file 'Dialog_wanpu.ui'
#
# Created: Thu Jan 29 19:48:05 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(443, 337)
        self.pushButton = QtGui.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(180, 300, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 14, 351, 91))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.lineEdit_3 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_3.setGeometry(QtCore.QRect(100, 56, 191, 20))
        self.lineEdit_3.setObjectName(_fromUtf8("lineEdit_3"))
        self.label_2 = QtGui.QLabel(self.groupBox)
        self.label_2.setGeometry(QtCore.QRect(20, 29, 91, 16))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtGui.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(20, 59, 81, 16))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.lineEdit_2 = QtGui.QLineEdit(self.groupBox)
        self.lineEdit_2.setGeometry(QtCore.QRect(100, 25, 191, 20))
        self.lineEdit_2.setObjectName(_fromUtf8("lineEdit_2"))
        self.label_18 = QtGui.QLabel(Dialog)
        self.label_18.setGeometry(QtCore.QRect(10, 264, 54, 12))
        self.label_18.setObjectName(_fromUtf8("label_18"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 114, 421, 121))
        ...
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 260, 361, 20))
    ...
    def initDialog(self):
        try:
            ...
            for child in metaConfigList:
                if child.attrib[key] == "XMGAME_CHANNEL_CODE":
                    self.lineEdit_2.setText(child.attrib[value])
                elif child.attrib[key] == "XMGAME_PRODUCT_CODE":
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Dialog_wanpu", None))
        self.pushButton.setText(_translate("Dialog", "确定", None))
        self.groupBox.setTitle(_translate("Dialog", "渠道信息", None))
        self.label_2.setText(_translate("Dialog", "CHANNEL_CODE", None))
        self.label_3.setText(_translate("Dialog", "PRODUCT_CODE", None))
...
class Dialogwanpu(QDialog,Ui_Dialog):  
    def __init__(self,parent=None):  
        super(Dialogwanpu,self).__init__(parent)  
        self.setupUi(self)
