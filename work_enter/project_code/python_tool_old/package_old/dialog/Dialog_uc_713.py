...
# Form implementation generated from reading ui file 'Dialog_uc_713.ui'
#
...
class Ui_Dialog_uc_713(object):
    def setupUi(self, Dialog_uc_713):
        Dialog_uc_713.setObjectName(_fromUtf8("Dialog_uc_713"))
        Dialog_uc_713.resize(445, 430)
        self.pushButton = QtGui.QPushButton(Dialog_uc_713)
        self.pushButton.setGeometry(QtCore.QRect(190, 390, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_uc_713)
        ...
        self.label_13 = QtGui.QLabel(Dialog_uc_713)
        self.label_13.setGeometry(QtCore.QRect(10, 350, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.lineEdit_11 = QtGui.QLineEdit(Dialog_uc_713)
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 346, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog_uc_713)
        ...
        self.retranslateUi(Dialog_uc_713)
        QtCore.QMetaObject.connectSlotsByName(Dialog_uc_713)
    ...
    def retranslateUi(self, Dialog_uc_713):
        Dialog_uc_713.setWindowTitle(_translate("Dialog_uc_713", "Config_uc", None))
        self.pushButton.setText(_translate("Dialog_uc_713", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_uc_713", "渠道信息", None))
        self.label_3.setText(_translate("Dialog_uc_713", "serverId", None))
        self.label_4.setText(_translate("Dialog_uc_713", "gameName", None))
        self.label_5.setText(_translate("Dialog_uc_713", "apiKey", None))
        self.label.setText(_translate("Dialog_uc_713", "cpId", None))
        self.label_2.setText(_translate("Dialog_uc_713", "gameId", None))
        self.label_13.setText(_translate("Dialog_uc_713", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_uc_713", "平台信息", None))
        self.label_7.setText(_translate("Dialog_uc_713", "gameId", None))
        self.label_8.setText(_translate("Dialog_uc_713", "platformId", None))
        self.label_9.setText(_translate("Dialog_uc_713", "appVersion", None))
        self.label_10.setText(_translate("Dialog_uc_713", "platformType", None))
        self.label_11.setText(_translate("Dialog_uc_713", "datacenter", None))
        self.label_12.setText(_translate("Dialog_uc_713", "resVersion", None))

class Dialoguc_713(QDialog,Ui_Dialog_uc_713):  
    def __init__(self,parent=None):  
        super(Dialoguc_713,self).__init__(parent)  
        self.setupUi(self)