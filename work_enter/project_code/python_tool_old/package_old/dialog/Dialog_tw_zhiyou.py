...
# Form implementation generated from reading ui file 'F:\android_pack_talkingdata\ui\Dialog_tw_zhiyou.ui'
#
...
class Ui_Dialog_tw_zhiyou(object):
    def setupUi(self, Dialog_tw_zhiyou):
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), Dialog_tw_zhiyou.onOkClicked)
        self.initDialog()
...
#             self.facebookid.setText(channel.get("facebookid"))
        ...
        try:
            valuesConfig=ET.parse(file_operate.getFullPath(constant.sdkRelatePath + ConfigParse.shareInstance().getChannelName()+"/ForRes/values/values.xml"))
    ...
    def onOkClicked(self):
        try:
            ...
            channel.set("statisticsAppId", unicode(self.statisticsAppId.text()))
...
#             channel.set("facebookid", unicode(self.facebookid.text()))
        ...
        try:
            ...
            for stringNode in stringNodeList:
                if stringNode.attrib['name']=="gamexdd_fb_app_id" :
                    stringNode.text=unicode(self.facebookid.text())
             
            valuesConfig.write(file_operate.getFullPath(constant.sdkRelatePath + ConfigParse.shareInstance().getChannelName() + "/ForRes/values/values.xml"), "utf-8")
            ...
            authorities = '{' + constant.androidNS + '}authorities'
            applicationCfg = configRoot.find("applicationCfg")
            if applicationCfg is None:
                return
            providerList = applicationCfg.findall("provider")
            
            for provider in providerList:
                if provider.attrib[key] == "com.facebook.FacebookContentProvider":
                    provider.set(authorities, 'com.facebook.app.FacebookContentProvider'+unicode(self.facebookid.text()))
    ...
    def retranslateUi(self, Dialog_tw_zhiyou):
        Dialog_tw_zhiyou.setWindowTitle(_translate("Dialog_tw_zhiyou", "Dialog", None))
        self.groupBox_2.setTitle(_translate("Dialog_tw_zhiyou", "平台信息", None))
        self.label_7.setText(_translate("Dialog_tw_zhiyou", "gameId", None))
        self.label_8.setText(_translate("Dialog_tw_zhiyou", "appVersion", None))
        self.label_9.setText(_translate("Dialog_tw_zhiyou", "datacenter", None))
        self.label_10.setText(_translate("Dialog_tw_zhiyou", "platformType", None))
        self.label_11.setText(_translate("Dialog_tw_zhiyou", "resVersion", None))
        self.label_12.setText(_translate("Dialog_tw_zhiyou", "platformId", None))
        self.pushButton.setText(_translate("Dialog_tw_zhiyou", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_tw_zhiyou", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_tw_zhiyou", "appKey", None))
        self.label_2.setText(_translate("Dialog_tw_zhiyou", "statisticsAppId", None))
        self.label_3.setText(_translate("Dialog_tw_zhiyou", "screenOrientation", None))
        self.label_4.setText(_translate("Dialog_tw_zhiyou", "竖屏：1   横屏：2", None))
        self.label.setText(_translate("Dialog_tw_zhiyou", "facebookid", None))
        self.label_13.setText(_translate("Dialog_tw_zhiyou", "包名", None))


class Dialogtw_zhiyou(QDialog,Ui_Dialog_tw_zhiyou):  
    def __init__(self,parent=None):  
        super(Dialogtw_zhiyou,self).__init__(parent)  
        self.setupUi(self)
