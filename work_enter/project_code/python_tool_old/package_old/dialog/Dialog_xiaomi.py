...
# Form implementation generated from reading ui file 'Dialog_xiaomi.ui'
#
# Created: Mon Jan 26 17:49:22 2015
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 236, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.label_13 = QtGui.QLabel(Dialog)
        self.label_13.setGeometry(QtCore.QRect(10, 240, 54, 12))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Dialog_xiaomi", None))
...
class Dialogxiaomi(QDialog,Ui_Dialog):  
    def __init__(self,parent=None):  
        super(Dialogxiaomi,self).__init__(parent)  
        self.setupUi(self)
