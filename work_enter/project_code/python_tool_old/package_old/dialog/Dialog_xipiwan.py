...
# Form implementation generated from reading ui file 'Dialog_xipiwan.ui'
#
...
class Ui_Dialog_xipiwan(object):
    def setupUi(self, Dialog_xipiwan):
        Dialog_xipiwan.setObjectName(_fromUtf8("Dialog_xipiwan"))
        Dialog_xipiwan.resize(447, 419)
        self.pushButton = QtGui.QPushButton(Dialog_xipiwan)
        self.pushButton.setGeometry(QtCore.QRect(180, 380, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_xipiwan)
        self.groupBox.setEnabled(True)
        self.groupBox.setGeometry(QtCore.QRect(30, 10, 381, 171))
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(80, 90, 191, 20))
        self.lineEdit_2.setObjectName(_fromUtf8("lineEdit_2"))
        self.label_13 = QtGui.QLabel(Dialog_xipiwan)
        self.label_13.setGeometry(QtCore.QRect(10, 340, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.lineEdit_11 = QtGui.QLineEdit(Dialog_xipiwan)
        self.lineEdit_11.setGeometry(QtCore.QRect(50, 336, 361, 20))
        self.lineEdit_11.setObjectName(_fromUtf8("lineEdit_11"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog_xipiwan)
        ...
        self.retranslateUi(Dialog_xipiwan)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Dialog_xipiwan)
        self.initDialog()

    def retranslateUi(self, Dialog_xipiwan):
        Dialog_xipiwan.setWindowTitle(_translate("Dialog_xipiwan", "Dialog_xipiwan", None))
        self.pushButton.setText(_translate("Dialog_xipiwan", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_xipiwan", "渠道信息", None))
        self.label.setText(_translate("Dialog_xipiwan", "appId", None))
        self.label_2.setText(_translate("Dialog_xipiwan", "appkey", None))
        self.label_13.setText(_translate("Dialog_xipiwan", "包名", None))
        self.groupBox_4.setTitle(_translate("Dialog_xipiwan", "平台信息", None))
        self.label_7.setText(_translate("Dialog_xipiwan", "gameId", None))
        self.label_8.setText(_translate("Dialog_xipiwan", "platformId", None))
        self.label_9.setText(_translate("Dialog_xipiwan", "appVersion", None))
        self.label_10.setText(_translate("Dialog_xipiwan", "platformType", None))
        self.label_11.setText(_translate("Dialog_xipiwan", "datacenter", None))
        self.label_12.setText(_translate("Dialog_xipiwan", "resVersion", None))
    ...
    def initDialog(self):
        try:
            ...
            for child in metaConfigList:
                if child.attrib[key] == "APPID":
                    self.lineEdit.setText(child.attrib[value])
                elif child.attrib[key] == "APPKEY":
...
class Dialogxipiwan(QDialog,Ui_Dialog_xipiwan):
    def __init__(self,parent=None):  
        super(Dialogxipiwan,self).__init__(parent)  
        self.setupUi(self)