...
# Form implementation generated from reading ui file 'F:\svnwork\Libs1\ReleaseSDK\android_pack_talkingdata\ui\Dialog_u8sdk.ui'
#
...
class Ui_Dialog_sy185(object):
    def setupUi(self, Dialog_sy185):
        Dialog_sy185.setObjectName(_fromUtf8("Dialog_sy185"))
        Dialog_sy185.resize(440, 361)
        self.pushButton = QtGui.QPushButton(Dialog_sy185)
        self.pushButton.setGeometry(QtCore.QRect(180, 320, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.groupBox = QtGui.QGroupBox(Dialog_sy185)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 361, 111))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.groupBox_4 = QtGui.QGroupBox(Dialog_sy185)
    ...
    def retranslateUi(self, Dialog_u8sdk):
        Dialog_u8sdk.setWindowTitle(_translate("Dialog_u8sdk", "Dialog_u8sdk", None))
        self.pushButton.setText(_translate("Dialog_u8sdk", "确定", None))
        self.groupBox.setTitle(_translate("Dialog_u8sdk", "渠道信息", None))
        self.groupBox_4.setTitle(_translate("Dialog_u8sdk", "平台信息", None))
        self.label_9.setText(_translate("Dialog_u8sdk", "gameId", None))
        self.label_10.setText(_translate("Dialog_u8sdk", "platformId", None))
        self.label_11.setText(_translate("Dialog_u8sdk", "appVersion", None))
        self.label_12.setText(_translate("Dialog_u8sdk", "platformType", None))
        self.label_14.setText(_translate("Dialog_u8sdk", "datacenter", None))
        self.label_15.setText(_translate("Dialog_u8sdk", "resVersion", None))
        self.label_13.setText(_translate("Dialog_u8sdk", "包名", None))
        
class Dialogsy185(QDialog,Ui_Dialog_sy185):  
    def __init__(self,parent=None):  
        super(Dialogsy185,self).__init__(parent)  
        self.setupUi(self)
