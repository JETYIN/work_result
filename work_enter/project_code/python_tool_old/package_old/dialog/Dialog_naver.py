...
# Form implementation generated from reading ui file 'Dialog_naver.ui'
#
# Created: Thu Jan 29 16:51:24 2015
...
class Ui_Dialog(object):
    ...
    def initDialog(self):
        try:
            ...
            self.lineEdit_2.setText(channel.get("base64PublicKey"))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Dialog_tstore", None))
...
class Dialognaver(QDialog,Ui_Dialog):  
    def __init__(self,parent=None):  
        super(Dialognaver,self).__init__(parent)  
        self.setupUi(self)
