...
class Ui_Dialog_nextmv_tstore(object):
    def setupUi(self, Dialog_nextmv_tstore):
        ...
        self.comboBox.setGeometry(QtCore.QRect(450, 240, 69, 22))
    ...
    def onOkClicked(self):
        try:
            ...
            channel.set("appcode", unicode(self.appId.text()))
            ...
            channel.set("mode", unicode(self.comboBox.currentText())) 
    ...
    def retranslateUi(self, Dialog_nextmv_tstore):
        ...
        self.comboBox.setItemText(0, _translate("Dialog_nextmv_tstore", "true", None))
        self.comboBox.setItemText(1, _translate("Dialog_nextmv_tstore", "debug", None))
...
class Dialognextmv_cultrue(QDialog,Ui_Dialog_nextmv_tstore):  
    def __init__(self,parent=None):  
        super(Dialognextmv_cultrue,self).__init__(parent)  
        self.setupUi(self)
