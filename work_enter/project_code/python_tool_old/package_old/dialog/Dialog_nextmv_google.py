...
# Form implementation generated from reading ui file 'Dialog_nextmv_google.ui'
#
# Created: Mon Jan 04 15:17:31 2016
...
class Ui_Dialog_nextmv_google(object):
    def setupUi(self, Dialog_nextmv_google):
        Dialog_nextmv_google.setObjectName(_fromUtf8("Dialog_nextmv_google"))
        Dialog_nextmv_google.resize(645, 529)
        self.groupBox = QtGui.QGroupBox(Dialog_nextmv_google)
        ...
        self.groupBox_2 = QtGui.QGroupBox(Dialog_nextmv_google)
    ...
    def retranslateUi(self, Dialog_nextmv_google):
        Dialog_nextmv_google.setWindowTitle(_translate("Dialog_nextmv_google", "Dialog_nextmv_google", None))
        self.groupBox.setTitle(_translate("Dialog_nextmv_google", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_nextmv_google", "facebook_app_id", None))
        self.label_2.setText(_translate("Dialog_nextmv_google", "nextmv_api_key", None))
        self.label_3.setText(_translate("Dialog_nextmv_google", "igaworks_app_key", None))
        self.label_4.setText(_translate("Dialog_nextmv_google", "igaworks_hash_key", None))
        self.label_5.setText(_translate("Dialog_nextmv_google", "funcellKey", None))
        self.label_6.setText(_translate("Dialog_nextmv_google", "base64PublicKey", None))
        self.label_14.setText(_translate("Dialog_nextmv_google", "naver_client_id", None))
        self.label_15.setText(_translate("Dialog_nextmv_google", "naver_client_secret", None))
        self.groupBox_2.setTitle(_translate("Dialog_nextmv_google", "平台信息", None))
        self.label_7.setText(_translate("Dialog_nextmv_google", "gameId", None))
        self.label_8.setText(_translate("Dialog_nextmv_google", "appVersion", None))
        self.label_9.setText(_translate("Dialog_nextmv_google", "datacenter", None))
        self.label_10.setText(_translate("Dialog_nextmv_google", "platformType", None))
        self.label_11.setText(_translate("Dialog_nextmv_google", "resVersion", None))
        self.label_12.setText(_translate("Dialog_nextmv_google", "platformId", None))
        self.pushButton.setText(_translate("Dialog_nextmv_google", "确定", None))
        self.label_13.setText(_translate("Dialog_nextmv_google", "包名", None))

class Dialognextmv_google(QDialog,Ui_Dialog_nextmv_google):  
    def __init__(self,parent=None):  
        super(Dialognextmv_google,self).__init__(parent)  
        self.setupUi(self)
