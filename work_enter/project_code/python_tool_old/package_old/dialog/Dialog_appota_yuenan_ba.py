...
class Ui_Dialog_appota_yuenan_ba(object):
    def setupUi(self, Ui_Dialog_appota_yuenan_ba):
        Ui_Dialog_appota_yuenan_ba.setObjectName(_fromUtf8("Dialog_appota_yuenan_ba"))
        Ui_Dialog_appota_yuenan_ba.resize(645, 529)
        self.groupBox = QtGui.QGroupBox(Ui_Dialog_appota_yuenan_ba)
        ...
        self.groupBox_2 = QtGui.QGroupBox(Ui_Dialog_appota_yuenan_ba)
        ...
        self.pushButton = QtGui.QPushButton(Ui_Dialog_appota_yuenan_ba)
        self.pushButton.setGeometry(QtCore.QRect(270, 490, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.packageName = QtGui.QLineEdit(Ui_Dialog_appota_yuenan_ba)
        self.packageName.setGeometry(QtCore.QRect(50, 460, 541, 20))
        self.packageName.setObjectName(_fromUtf8("packageName"))
        self.label_13 = QtGui.QLabel(Ui_Dialog_appota_yuenan_ba)
        self.label_13.setGeometry(QtCore.QRect(10, 460, 54, 12))
        self.label_13.setObjectName(_fromUtf8("label_13"))

        self.retranslateUi(Ui_Dialog_appota_yuenan_ba)
        self.pushButton.clicked.connect(self.onOkClicked)
        QtCore.QMetaObject.connectSlotsByName(Ui_Dialog_appota_yuenan_ba)
        self.initDialog()
    ...
    def retranslateUi(self, Dialog_appota_yuenan_ba):
        Dialog_appota_yuenan_ba.setWindowTitle(_translate("Dialog_appota_yuenan_ba", "Dialog_appota_yuenan_ba", None))
        self.groupBox.setTitle(_translate("Dialog_appota_yuenan_ba", "渠道参数", None))
        self.label_1.setText(_translate("Dialog_appota_yuenan_ba", "twitter_consumer_key", None))
        self.label_2.setText(_translate("Dialog_appota_yuenan_ba", "twitter_consumer_secret", None))
        self.label_3.setText(_translate("Dialog_appota_yuenan_ba", "facebook_app_id", None))
        self.label_4.setText(_translate("Dialog_appota_yuenan_ba", "appsflyer_dev_key", None))
        self.label_5.setText(_translate("Dialog_appota_yuenan_ba", "gmo_apiKey", None))
        self.label_6.setText(_translate("Dialog_appota_yuenan_ba", "gmo_clientId", None))
        self.label_14.setText(_translate("Dialog_appota_yuenan_ba", "crashlytics_ApiKey", None))
        self.label_15.setText(_translate("Dialog_appota_yuenan_ba", "FacebookAppLinkUrl", None))
        self.groupBox_2.setTitle(_translate("Dialog_appota_yuenan_ba", "平台信息", None))
        self.label_7.setText(_translate("Dialog_appota_yuenan_ba", "gameId", None))
        self.label_8.setText(_translate("Dialog_appota_yuenan_ba", "appVersion", None))
        self.label_9.setText(_translate("Dialog_appota_yuenan_ba", "datacenter", None))
        self.label_10.setText(_translate("Dialog_appota_yuenan_ba", "platformType", None))
        self.label_11.setText(_translate("Dialog_appota_yuenan_ba", "resVersion", None))
        self.label_12.setText(_translate("Dialog_appota_yuenan_ba", "platformId", None))
        self.pushButton.setText(_translate("Dialog_appota_yuenan_ba", "确定", None))
        self.label_13.setText(_translate("Dialog_appota_yuenan_ba", "包名", None))

class Dialogyuenan_appota_ba(QDialog,Ui_Dialog_appota_yuenan_ba):
    def __init__(self,parent=None):  
        super(Dialogyuenan_appota_ba,self).__init__(parent)  
        self.setupUi(self)
