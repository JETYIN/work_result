...
//				| WindowManager.LayoutParams.TYPE_SYSTEM_OVERLAY;
	...
	public static boolean onTouchEvent(MotionEvent event, View view) {
		...
		x = event.getRawX();
		y = event.getRawY(); //y = event.getRawY()-25; 25是系统状态栏的高度    //游戏为全屏,貌似不存在-25操作
	...
	public static void initFloatToolBar(final Context context) {
		...
		userBtn.setTextColor(context.getResources().getColor(
				RUtils.color(context, "fun_floating_view_text")));
		final Drawable accountCenterDrawableTop = context.getResources()
				...
				((Activity) context).runOnUiThread(new Runnable() {
					...
					public void run() {
						...
						builder.setMessage(context.getResources().getString(
								RUtils.string(context, "fun_error_page_dialog_msg_title")));
						builder.setTitle(context.getResources().getString(
								RUtils.string(context, "fun_error_page_head_title")));
						builder.setPositiveButton(
								context.getResources()
										.getString(
												RUtils.string(context, "fun_error_page_dialog_btn_sure_title")),
						...
						builder.setNegativeButton(
								context.getResources()
										.getString(
												RUtils.string(context, "fun_error_page_dialog_btn_cancel_title")),
